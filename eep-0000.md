...
<TD align='left'>Implemented in OTP release 27.0</TD>
</TR>
<TR>
<TD align='left'>/24.0</TD>
<TD align='left'>Implemented in OTP version 24.0</TD>
</TR>
<TR>
...
<TD align='left'>Implemented in OTP release 23.0</TD>
</TR>
<TR>
...
<pre><code>File eep-0059.md: 'status:' tag Implemented in OTP version 27.0 ne Implemented in OTP release 27.0!
File eep-0066.md: 'status:' tag Implemented in OTP version 27.0;        the regular expression sigils (`~r` and `~R`) are not implemented ne Implemented in OTP release 27.0!
File eep-0052.md: 'status:' tag Implemented in OTP version 23.0 ne Implemented in OTP release 23.0!
File eep-0056.md: 'status:' tag Implemented in OTP release 24.0 ne Implemented in OTP version 24.0!
</code></pre>
